...
<body>
		...
		<div class="row row-cols-3 row-cols-md-3 g-4 mb-5"  style="width: 70rem;">
			<c:forEach items="${list}" var="dto">
		  		...
		  		<div class="card-header">
		   		...
		   		<div class="card">
		   			<a href="officeDetail.do?pCode=${dto.pCode}&pClick=${dto.pClick}">
	...
	<div class="listnumber">
					<nav aria-label="Page navigation example">
					  <ul class="pagination justify-content-center">
					    ...
					    <li class="page-item"><a class="page-link"  href="officeCategory.do?">1</a></li>
	...
	%>
					    <li class="page-item"><a class="page-link" href= "officeCategoryPage.do?startnum=<%=contentNum*i%>&endnum=<%=contentNum%>"><%=i+1 %></a></li>
					    <li class="page-item">
