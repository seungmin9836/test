...
<body>
	...
	<form action="/finduserid.do">
		...
		<table>
			<tr>
				<td>성명</td>
				<td><input type="text" name="finduseridname"></td>
			</tr>
			<tr>
				<td>이메일</td>
				<td><input type="text" name="finduseridemail"></td>
			</tr>
			<tr>
				<td></td>
	...
	<form action="/finduserpw.do">
		...
		<table>
			<tr>
				<td>성명</td>
				<td><input type="text" name="finduserpwname"></td>
			</tr>
			<tr>
				<td>아이디</td>
				<td><input type="text" name="finduserpwid"></td>
			</tr>
			<tr>
				<td>이메일</td>
				<td><input type="text" name="finduserpwemail"></td>
			</tr>
			<tr>
				<td></td>
